...
path( NumCitiesRemainingToBeVisited, RemainingKm, CurrentCity, CitiesAlreadyVisited, [CurrentCity1|Path] ):-
    NumCitiesRemainingToBeVisited >= 1, RemainingKm > 0,
    road1( CurrentCity-CurrentCity1, K ),
    \+member(CurrentCity1, CitiesAlreadyVisited),
    RecentKm is RemainingKm - K,
    NumCitiesRemaining is NumCitiesRemainingToBeVisited - 1,
    path(NumCitiesRemaining, RecentKm, CurrentCity1, [CurrentCity1|CitiesAlreadyVisited], Path).
